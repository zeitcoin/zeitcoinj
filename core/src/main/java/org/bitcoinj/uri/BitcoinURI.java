...
public class BitcoinURI {
    ...
    public static final String BITCOIN_SCHEME = "zeitcoin";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  zeitcoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form zeitcoin://address?....
        ...
        // For instance with : zeitcoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        // the & (%26) in Tom and Jerry gets interpreted as a separator and the label then gets parsed
        // as 'Tom ' instead of 'Tom & Jerry')
        String schemeSpecificPart;
        if (input.startsWith("zeitcoin://")) {
            schemeSpecificPart = input.substring("zeitcoin://".length());
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the zeitcoin: prefix");
